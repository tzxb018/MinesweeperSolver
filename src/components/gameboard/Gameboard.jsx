  ...
  background = () => {
    ...
    return (
      <svg className={styles['svg']} height={height} width={width}>
        <polygon points={`0,0 ${width},0 ${width - 2},2 2,${height - 2} 0,${height}`}
          style={Gameboard.lightBorderGray}
        />
        <polygon points={`${width},${height} 0,${height} 2,${height - 2} ${width - 2},2 ${width},0`}
          style={Gameboard.darkBorderGray}
        />
        <polygon points={`2,2 ${width - 2},2 ${width - 2},${height - 2} 2,${height - 2}`} style={Gameboard.gray} />
        <polygon points={`8,8 ${width - 8},8 ${width - 10},10 10,10 10,42 8,44`} style={Gameboard.darkBorderGray} />
