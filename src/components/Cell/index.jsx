...
export default class Cell extends Component {
  ...
  componentCell = () => {
    ...
    return (
      <div className={styles['tooltip']} onClick={this.clickHandler} onContextMenu={this.rightClickHandler}>
        ...
        <span className={styles['tooltiptext']}>
          {this.props.solution ?
            <svg height="16" width="16">
              ...
              <path d="M4 4 L5 4 L5 5 L4 5 M8 2 L9 2 L9 4 L8 4 M12 4 L13 4 L13 5 L12 5 M13 8 L15 8 L15 9 L13 9 M12 12
                L13 12 L13 13 L12 13 M8 13 L9 13 L9 15 L8 15 M4 12 L5 12 L5 13 L4 13 M2 8 L4 8 L4 9 L2 9Z"
                fill="black"
              />
            ...
            <svg height="16" width="16">
              <polygon points="0,0 16,0 16,16 0,16" style={this.darkBorderGray} />
              <polygon points="1,1 16,1 16,16 1,16" style={this.gray} />
            </svg>
          }
        </span>
      </div>
  ...
  revealedCell = () => (
    <svg height="16" width="16">
      ...
      {this.numbers[this.props.mines - 1]}
    </svg>
  )
